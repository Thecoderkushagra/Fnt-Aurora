                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            disabled={!isEditing}
                            className={`w-full px-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${isEditing ? 'border-gray-600' : 'border-transparent cursor-not-allowed opacity-70'
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className={`w-full px-4 py-3 bg-gray-800 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all resize-none ${isEditing ? 'border-gray-600' : 'border-transparent cursor-not-allowed opacity-70'
                                } ${errors.bio ? 'border-red-500' : ''}`}
                        />
                        <div className="flex justify-between items-center mt-1">
                            {errors.bio && <p className="text-red-400 text-sm">{errors.bio}</p>}
                            <p className={`text-sm ml-auto ${currentProfile.bio.length > MAX_BIO_LENGTH * 0.9
                                    ? 'text-yellow-400'
                                    : 'text-gray-400'
                                }`}>
